...
BOOL CDemoDlg::OnInitDialog()
{
	...
	m_Graph1.SetXLabel(L"");
    m_Graph1.SetYLabel(L"");
	m_Graph1.SetCaption(L"");

	m_Graph2.SetCaption(L"XY Plot");
...
void CDemoDlg::SetPlotFace(CNTGraph *graph)
{
	...
	graph->SetXLabel(L"X Axis");
	graph->SetYLabel(L"Y Axis");
...
void CDemoDlg::Demo1()
{
  ...
  if(m_Graph2.GetFrameStyle()==2)
  {
	  ...
	  m_Graph2.SetCaption(L"Have a brake on left side!");
  }
  else
  {
	  m_Graph2.SetCaption(L"NTGraph Demo");
	  m_Graph2.SetElementLineColor(RGB(255,0,0));
	  m_Graph2.SetElementIdentify(TRUE);
	  m_Graph2.SetElementPointColor(RGB(0,0,255));
	  m_Graph2.SetElementPointSymbol(4);
...
void CDemoDlg::Demo3(int linetype)
{
  ...
  case 6: // XY Steps
	  ...
	  m_Graph2.SetCaption(L"Demo3: Linetype 6: XY Steps");
      break;
  case 7: // YX Steps
	  m_Graph2.SetElementLinetype(7);
	  m_Graph2.SetCaption(L"Linetype 7: YX Steps");
      break;
  case 8: // Bars
  	  m_Graph2.SetElementLinetype(8);
	  m_Graph2.SetCaption(L"Linetype 8: Bars");
      break;
  case 9: // Stick
  	  m_Graph2.SetCaption(L"Linetype 9: Stick");
	  m_Graph2.SetElementLinetype(9);
      break;

  case 10: // Stick
  	  m_Graph2.SetCaption(L"With more points...");
	  m_Graph2.SetElementLinetype(9);
...
void CDemoDlg::Demo4(int symbol)
{
  ...
  case 1: 
	  ...
	  m_Graph2.SetCaption(L"Demo4: Symbol 1: Empty Dot");
	  m_Graph2.SetElementSolidPoint(TRUE);
      break;
  case 2: 
	  m_Graph2.SetElementPointSymbol(2);
	  m_Graph2.SetCaption(L"Symbol 2: Empty Rectangle");
	  m_Graph2.SetElementSolidPoint(TRUE);
      break;
  case 3: 
  	  m_Graph2.SetElementPointSymbol(3);
	  m_Graph2.SetCaption(L"Symbol 3: Empty Diamond");
	  m_Graph2.SetElementSolidPoint(TRUE);
      break;
  case 4: 
  	  m_Graph2.SetElementPointSymbol(4);
	  m_Graph2.SetCaption(L"Symbol 4: Empty Asterisk");
	  m_Graph2.SetElementSolidPoint(TRUE);
      break;
  case 5: 
	  m_Graph2.SetElementPointSymbol(5);
	  m_Graph2.SetCaption(L"Symbol 5: Empty Down Triangle");
	  m_Graph2.SetElementSolidPoint(TRUE);
      break;
  case 6: 
	  m_Graph2.SetElementPointSymbol(6);
	  m_Graph2.SetCaption(L"Symbol 6: Empty Up Triangle");
	  m_Graph2.SetElementSolidPoint(TRUE);
      break;
  case 7: 
  	  m_Graph2.SetElementPointSymbol(7);
	  m_Graph2.SetCaption(L"Symbol 7: Empty Left Triangle");
	  m_Graph2.SetElementSolidPoint(TRUE);
      break;
  case 8: 
  	  m_Graph2.SetElementPointSymbol(8);
	  m_Graph2.SetCaption(L"Symbol 8: Empty Right Triangle");
	  m_Graph2.SetElementSolidPoint(TRUE);
      break;
  case 9: 
	  m_Graph2.SetElementPointSymbol(1);
	  m_Graph2.SetCaption(L"Demo4: Symbol 1: Full Dot");
	  m_Graph2.SetElementSolidPoint(TRUE);
      break;
  case 10: 
	  m_Graph2.SetElementPointSymbol(2);
	  m_Graph2.SetCaption(L"Symbol 2: Full Rectangle");
	  m_Graph2.SetElementSolidPoint(FALSE);
      break;
  case 11: 
  	  m_Graph2.SetElementPointSymbol(3);
	  m_Graph2.SetCaption(L"Symbol 3: Full Diamond");
	  m_Graph2.SetElementSolidPoint(FALSE);
      break;
  case 12: 
  	  m_Graph2.SetElementPointSymbol(4);
	  m_Graph2.SetCaption(L"Symbol 4:  Full Asterisk");
	  m_Graph2.SetElementSolidPoint(FALSE);
      break;
  case 13: 
	  m_Graph2.SetElementPointSymbol(5);
	  m_Graph2.SetCaption(L"Symbol 5:  Full Down Triangle");
	  m_Graph2.SetElementSolidPoint(FALSE);
      break;
  case 14: 
	  m_Graph2.SetElementPointSymbol(6);
	  m_Graph2.SetCaption(L"Symbol 6:  Full Up Triangle");
	  m_Graph2.SetElementSolidPoint(FALSE);
      break;
  case 15: 
  	  m_Graph2.SetElementPointSymbol(7);
	  m_Graph2.SetCaption(L"Symbol 7:  Full Left Triangle");
	  m_Graph2.SetElementSolidPoint(FALSE);
      break;
  case 16: 
  	  m_Graph2.SetElementPointSymbol(8);
	  m_Graph2.SetCaption(L"Symbol 8:  Full Right Triangle");
	  m_Graph2.SetElementSolidPoint(FALSE);
      break;
  }
  ...
  m_Graph2.SetCaption(L"2D Graph Demo");
